            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Driver Management | Create</h1>
                    </div>
                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <form action="{{route('createDriverManage')}}" method="post" role="form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required name="gender_driver">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type='text' class="form-control" required name="telp_driver"></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Pengalaman Kerja (Tahun)</label>
                                        <input type='number' class="form-control" required
                                            name="pengalaman_driver"></input>
                                    </div>

                                    <div class="form-group">
                                        <label>Gambar Lisensi (SIM)</label>
                                        <input type="file" class="form-control-file" required name="gambar_sim">
                                    </div>
