            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0  text-gray-800" style="margin-left: 50px;">User Profile</h1>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        <!-- Informasi User -->
                                        <p class="card-title"><strong>Username:</strong> {{ $user->username }}</p>
                                        <p class="card-text"><strong>Email:</strong> {{ $user->email }}</p>
                                        <p class="card-text"><strong>Nomor Telepon:</strong> {{ $user->no_telp }}</p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
