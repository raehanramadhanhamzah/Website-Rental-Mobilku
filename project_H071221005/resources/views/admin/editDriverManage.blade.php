            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Driver Management | Edit</h1>
                    </div>
                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <form action="{{route('editDriverManage', ['id' => $driver]) }})}}" method="post"
                                    role="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label>Nama Driver</label>
                                        <input type="text" name="nama_driver" required="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Jenis Kelamin</label>
                                        <select class="form-control" name="gender_driver">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type='text' class="form-control" name="telp_driver"></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Pengalaman Kerja (Tahun)</label>
                                        <input type='number' class="form-control" name="pengalaman_driver"></input>
                                    </div>

                                    <div class="form-group">
                                        <label>Gambar Lisensi (SIM)</label>
                                        <input type="file" class="form-control-file" name="gambar_sim">
                                    </div>
