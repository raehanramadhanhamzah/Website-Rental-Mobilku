                    ...
                    <div class="container mt-8">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card">
                                    <img src="{{ asset('storage/'.$car->gambar_path) }}" alt="Car Image"
                                        class="card-img-top" width="300" height="200">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $car->merk }} {{ $car->model }}</h5>
                                        <p class="card-text"><strong>Rp/Hari:</strong> Rp.{{ $car->harga_per_hari }}</p>
                                        <p class="card-text"><strong>Status:</strong> <span style="color: #00ff30;">{{
                                                $car->status }}</span></p>
                                    </div>
                                </div>
                            </div>
