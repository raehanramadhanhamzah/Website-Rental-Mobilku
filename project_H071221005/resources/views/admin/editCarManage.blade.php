            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Car Management | Edit</h1>
                    </div>
                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <form action="{{route('editCarManage', ['id' => $car]) }}" method="post" role="form"
                                    ...
                                    <div class="form-group">
                                        <label>Model</label>
                                        <input type="text" name="model_mobil" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>Tahun</label>
                                        <input type='number' class="form-control" name="tahun_mobil"></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Plat Nomor</label>
                                        <input class="form-control" name="plat_mobil"></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Transmisi</label>
                                        <select class="form-control" name="transmisi_mobil">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type='number' class="form-control" name="harga_mobil"></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Gambar Mobil</label>
                                        <input type="file" class="form-control-file" name="gambar_mobil" accept="image/*">
                                    </div>
