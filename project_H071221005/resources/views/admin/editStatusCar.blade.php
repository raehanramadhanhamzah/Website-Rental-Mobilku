                ...
                <div class="container-fluid">
                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <form action="{{ route('editStatusCarManage', ['id' => $car]) }}" method="post"
                                    role="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="status_mobil">Status Mobil</label>
                                        <select name="status_mobil" class="form-control" required>
                                            <option value="Available" {{ $car->status_mobil == 'Available' ? 'selected'
                                                : '' }}>Available</option>
                                            <option value="Booked" {{ $car->status_mobil == 'Booked' ? 'selected' : ''
                                                }}>Booked</option>
                                        </select>
                                    </div>
