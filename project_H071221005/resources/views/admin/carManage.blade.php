                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            <div class="card-header  text-white ">
                                <a href="{{route('createCarManage')}}" class="btn btn-sm btn-primary float-right">Tambah
                                    Data</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$car->status}}</td>
                                            <td>
                                                <a href="{{ route('editStatusCarView',['id' => $car->id])}}"
                                                    class="btn btn-sm btn-primary">Ubah Status</a>
                                                <a href="{{ route('editCarView',['id' => $car->id])}}"
                                                    class="btn btn-sm btn-warning">Edit Mobil</a>
                                                <a href="{{ route('deleteCarManageAdmin', ['id' => $car->id]) }}"
