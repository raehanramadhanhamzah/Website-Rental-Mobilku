                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            <div class="card-header text-white ">
                                <a href="{{route('createDriverManage')}}"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$driver->pengalaman_kerja}}</td>
                                            <td>{{$driver->status}}</td>
                                            <td>
                                                    <a href="{{ route('editStatusDriverView',['id' => $driver->id])}}"
                                                        class="btn btn-sm btn-primary">Ubah Status</a>
                                                    <a href="{{ route('editDriverView',['id' => $driver->id])}}"
                                                        class="btn btn-sm btn-warning">Edit Data Driver</a>
                                                    <a href="{{ route('deleteDriverManage', ['id' => $driver->id]) }}"
