            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Payment Management | Edit</h1>
                    </div>
                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <form action="{{ route('editStatusPaymentManage', ['id' => $payment]) }}" method="post"
                                    role="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="status_payment">Status Pembayaran</label>
                                        <select name="status_payment" class="form-control" required>
                                            <option value="Pending" {{ $payment->status_payment == 'Pending' ? 'selected'
                                                : '' }}>Pending</option>
                                            <option value="Cancelled" {{ $payment->status_payment == 'Cancelled' ? 'selected'
                                                : '' }}>Cancelled</option>
                                            <option value="Paid" {{ $payment->status_payment == 'Paid' ? 'selected' : ''
                                                }}>Paid</option>
                                        </select>
                                    </div>
