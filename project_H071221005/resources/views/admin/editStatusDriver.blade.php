                ...
                <div class="container-fluid">
                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <form action="{{ route('editStatusDriverManage', ['id' => $driver]) }}" method="post"
                                    role="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="status_driver">Status Driver</label>
                                        <select name="status_driver" class="form-control" required>
                                            <option value="Available" {{ $driver->status_driver == 'Available' ? 'selected'
                                                : '' }}>Available</option>
                                            <option value="Booked" {{ $driver->status_driver == 'Booked' ? 'selected' : ''
                                                }}>Booked</option>
                                        </select>
                                    </div>
