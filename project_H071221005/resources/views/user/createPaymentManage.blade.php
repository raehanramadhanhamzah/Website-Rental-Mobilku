            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Payment Management | Halaman Pembayaran</h1>
                    </div>
                    ...
                    <div class="container col-md-12 mt-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    <p>Jumlah Yang Harus Dibayarkan : <span style="color: red;">Rp.{{ $totalAmount
                                            }}</span></p>

                                    <p>========================</p>
                                </div>

                                <form action="{{route('createPaymentManage')}}" method="post" role="form"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label>Total Pembayaran</label>
                                        <input type="text" name="total_pembayaran" required class="form-control">
                                    </div>
                                    @if(session('sessionIdOrder'))
                                    <input type='hidden' class="form-control" name="id_order"
                                        value="{{ session('sessionIdOrder') }}"></input>
                                    @endif
                                    @if($totalAmount == 0)
