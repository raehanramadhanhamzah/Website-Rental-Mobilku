            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"
                        action="{{ route('driverListUser') }}" method="GET">
                    ...
                    <!-- Formulir Filter -->
                    <form class="form-inline mb-2" action="{{ route('driverListUser') }}" method="GET">
                        <div class="form-group mr-2">
                            <label for="driverFilter">Filter Jenis Kelamin :</label>
                            <select class="form-control" id="driverFilter" name="gender">
