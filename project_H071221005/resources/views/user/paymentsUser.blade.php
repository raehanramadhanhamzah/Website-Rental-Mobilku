            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="margin-left: 50px;">Payments</h1>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="mb-4">
                                ...
                                @endif
                                <form action="{{ route('paymentsUser') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <label for="id_order">ID Order</label>
                                    <br>
                                    <input type="number" name="id_order" id="id_order" accept="image/*" required>
                                    <br>
                                    <br>
                                    <label for="bukti_pembayaran">Kirim Bukti Pembayaran</label>
                                    <br>
